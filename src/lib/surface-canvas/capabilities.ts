...
const CAPABILITIES: Record<SurfaceId, readonly SurfaceCapability[]> = {
  code: [
    {
      id: "sfdx-project", label: "Start an SFDX project",
    ...
    {
      id: "react-app", label: "Build a React app",
    ...
    {
      id: "query", label: "Query your data",
    ...
    {
      id: "tests", label: "Create & run tests",
    ...
    {
      id: "toolkit", label: "Your toolkit", group: "toolkit",
  ...
  build: [
    ...
    {
      id: "experience", label: "Build an experience",
  ...
  govern: [
    {
      id: "security", label: "Review security",
    ...
    {
      id: "health", label: "Monitor platform health",
    ...
    {
      id: "policies", label: "Define a policy",
    ...
    {
      id: "agent-activity", label: "Observe agent activity",
  ...
  alm: [
    ...
    {
      id: "validation", label: "Validate a change",
    ...
    {
      id: "release", label: "Prepare a release",
...
export const TOOLKIT_SECTIONS = [
  { id: "skills", label: "Skills", description: "Reusable instructions and workflows for your agents.", fields: [
  ...
  { id: "plugins", label: "Plugins", description: "Packages that bring related capabilities into your workspace.", fields: [
  ...
  { id: "connectors", label: "Connectors", description: "Connect the services and data your work depends on.", fields: [
  ...
  { id: "mcp", label: "MCP tools", description: "Give agents access to tools exposed by MCP servers.", fields: [
...
] as const satisfies readonly { id: string; label: string; description: string; fields: readonly CapabilityField[] }[];
