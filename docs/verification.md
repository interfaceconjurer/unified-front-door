...
| Assessment scope, captured findings, rescan and retry; interrupted post-commit refresh replays the same rescan without creating another run | `assessment-canvas.mjs` (fixture receipts retain command identity) | `assessment-canvas.test.mjs` |
